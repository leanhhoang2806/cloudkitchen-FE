...
import { Typography, Divider, List, ListItem, ListItemText, ListItemAvatar, ListItemSecondaryAction, Avatar, Button } from '@mui/material';
...
function CheckoutOrdersPage() {
  ...
  return (
    ...
    <div style={{ width: '80%', margin: 'auto', backgroundColor: 'white', padding: '20px', marginTop: '20px' }}>
      ...
      {/* Checkout button */}
      <Button variant="contained" color="primary" style={{ alignSelf: 'flex-end' }} onClick={handleCheckout}>
        CHECKOUT
      </Button>
    </div>
